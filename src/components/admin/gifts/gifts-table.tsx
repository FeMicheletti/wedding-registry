			...
			renderMobileItem={(gift) => (
				<article className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm">
					...
					<div className="mt-5 grid grid-cols-2 gap-2">
						<Link href={`/admin/presentes/${gift.id}/editar`} className="inline-flex items-center justify-center rounded-xl border border-zinc-300 bg-white px-3 py-3 text-sm font-medium text-zinc-700 transition hover:bg-zinc-100">
							Editar
						</Link>
						...
						<form action={deleteGiftAction.bind( null, gift.id,)} className="col-span-2">
