	...
	return (
		<div className="space-y-8 sm:space-y-10">
			...
			<section className="grid gap-3 sm:grid-cols-2 sm:gap-4 xl:grid-cols-4">
				{cards.map((card) => (
					<article key={card.label} className="rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm transition hover:-translate-y-0.5 hover:border-zinc-300 hover:shadow-md sm:p-6">
						<p className="text-sm font-medium text-zinc-500">
							{card.label}
						</p>
